...
sub Main( )
    ...
    if objArgs.Count = 3 then
        ...
        szMsg = "To share your internet connection, please provide " & _
				"the name of the private and public connections as the argument." & _
				vbCRLF & vbCRLF & "Usage:" & vbCRLF & "       " & WScript.scriptname & _
				" " & chr(34) & "Private Connection Name" & chr(34) & " " & _
				chr(34) & "Public Connection Name" & chr(34)
            ...
            if EveryConnection.SharingEnabled = False and switch="on" then
                ...
                szMsg = " Shared!"
						elseif(switch = "off") then 
								szMsg = szMsg & vbCRLF & _
										"Shared... DisEnabling private connection share..."
                WScript.Echo(szMsg)
        ...
        if objNCProps.Name = con2 then
            ...
            if EveryConnection.SharingEnabled = False and switch="on" then
                ...
                szMsg = " Shared!"
						elseif(switch = "off") then 
								szMsg = szMsg & vbCRLF & _
										"Shared... DisEnabling public connection share..."
                WScript.Echo(szMsg)
								EveryConnection.EnableSharing CONNECTION_ALL
           	end if
        end if
